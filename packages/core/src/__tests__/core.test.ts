...
import {
  createProofOfAgreementPayload,
  createProofOfAuthorityPayload,
  createSignedProofPayload,
} from "../index";
...
describe("verifyProof", () => {
  ...
  it("should throw an error for a proof with incorrect verifyingContract", () => {
    ...
    expect(() => verifyProof(invalidProof)).toThrow(
      "Proof verifyingContract malformed"
    );
  });
  ...
  it("should throw an error for a proof with malformed message keys", () => {
    const payload = {
      from: "0xb1ff285b5e42cd2a0abf67e4552cf5a6986edba4",
      agreementCID: "QmVoErhYkkYzSXuswEmLg6K2UY2T45xd8V3ugyfybxHXct",
      signers: ["0xb1ff285b5e42cd2a0abf67e4552cf5a6986edba4"],
    };
  ...
  it("should create correct signed PoAf payload", () => {
    const payload = {
      address: "0xb1ff285b5e42cd2a0abf67e4552cf5a6986edba4",
      sig: "0x",
      data: {
        ...ProofOfAuthorityTemplate,
        message: {
